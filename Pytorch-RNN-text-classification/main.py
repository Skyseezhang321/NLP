...
train_loader = TextClassDataLoader('data/train1.csv', d_word_index, batch_size=args.batch_size)
val_loader = TextClassDataLoader('data/test1.csv', d_word_index, batch_size=args.batch_size)
